...
from specops_lib.config.schema import DockerSecurityConfig
from specops_lib.registry import get_software_registry

logger = logging.getLogger(__name__)

DOCKER_HOST = os.environ.get("DOCKER_HOST", "")
DOCKER_IMAGE = os.environ.get("AGENT_IMAGE", "ghcr.io/taylorelley/specops:latest")
...
class DockerRuntime(WorkerRuntimeBase):
    ...
    async def start_agent(self, agent_id: str) -> None:
        ...
        try:
            ...
            ssl_toggle = os.environ.get("SPECOPS_DISABLE_SSL_VERIFY")
            if ssl_toggle:
                env["SPECOPS_DISABLE_SSL_VERIFY"] = ssl_toggle
            ...
            def _run():
                ...
                kwargs: dict[str, Any] = {
                    "image": DOCKER_IMAGE,
                    "command": ["python", "-m", "specialagent.worker.app"],
                    "detach": True,
                    "name": name,
                    "environment": env,
                    "volumes": volumes,
