"""Sharing endpoints for specialagents (agents) and plans.
...
from specops.core.authz import require_agent_manage
from specops.core.plan_access import require_plan_manage
