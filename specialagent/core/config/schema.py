...
Re-exports the shared Config from specops_lib/ and adds provider-matching methods
that depend on specialagent.providers.registry (not shared with specops).
"""

import os

from specialagent.providers.registry import PROVIDERS, find_by_name
from specops_lib.config.schema import *  # noqa: F401,F403
from specops_lib.config.schema import Config as _BaseConfig
from specops_lib.config.schema import ProviderConfig
