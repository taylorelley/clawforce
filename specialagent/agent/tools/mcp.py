"""MCP client: connects to MCP servers and wraps their tools as native specialagent tools.
...
from specops_lib.http import httpx_verify, ssl_verify_disabled

_NODE_COMMANDS = frozenset({"node", "npx", "tsx"})


class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a specialagent Tool."""
