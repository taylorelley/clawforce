...
import { useAddCustomPlanTemplate, useSpecialAgents, useUpdateCustomPlanTemplate } from "../lib/queries";
        ...
        <div>
          ...
          {specialagents.length === 0 ? (
            <p className="text-[11px] text-claude-text-muted italic">
              No specialagents available yet. Create a specialagent first to preassign it here.
            </p>
          ) : (
            ...
            {form.tasks.map((task, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  {task.agent_id && !specialagents.some((c) => c.id === task.agent_id) && (
