"""Integration tests for multiuser roles and sharing on specialagents and plans."""
...
class TestRoleValidation:
    def test_cli_valid_roles(self):
        from specops.core.store.users import VALID_ROLES
...
class TestPermissionHelper:
    def test_at_least_rejects_unknown_required(self):
        from specops.core.domain.share import at_least
