...
Provides a single toggle — the ``SPECOPS_DISABLE_SSL_VERIFY`` environment
variable — for disabling TLS certificate verification across specops,
specialagent, specops_lib, and every specialagent (agent) spawned by the runtime.
...
ENV_VAR = "SPECOPS_DISABLE_SSL_VERIFY"
