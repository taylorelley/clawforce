...
from specops_lib.config.schema import EmailConfig
from specops_lib.http import insecure_ssl_context, ssl_verify_disabled
...
class EmailChannel(BaseChannel):
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        base_subject = self._last_subject_by_chat.get(to_addr, "SpecialAgent reply")
    ...
    def _reply_subject(self, base_subject: str) -> str:
        subject = (base_subject or "").strip() or "SpecialAgent reply"
